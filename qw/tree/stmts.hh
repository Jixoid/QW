...
namespace qw::stmts
{
  ...
  struct CodeVar   { std::string name; types::Type *targetType{}; llvm::AllocaInst *llvm{}; bool has_init_expr{false}; };
  struct ExprStmt  { exprs::Expr *expr{}; };

  struct IfStmt    { exprs::Expr *condition{}; Stmt *then_block{}; Stmt *else_block{}; /* optional */ };
  struct WhileStmt { exprs::Expr *condition{}; Stmt *body{}; llvm::BasicBlock *cond_block{}; llvm::BasicBlock *end_block{}; };

  struct ReturnStmt   { exprs::Expr *expr{}; };
  struct BreakStmt    { Stmt *loop{}; };
  struct ContinueStmt { Stmt *loop{}; };

  struct UnsafeStmt   { Stmt *stmt{}; };
  ...
  struct Stmt: identy
  {
    ...
    public:
      ...
      static fun make_Unsafe(qw::context *ctx, identy *parent, word pos, Stmt *stmt) -> Stmt*;
