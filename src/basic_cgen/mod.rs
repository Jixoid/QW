...
impl<'a> BasicCGen<'a> {
	...
	fn type_to_llvm<'ctx>(&self, ctx: &'ctx Context, hir_mol: &crate::hir::module::HirModule, ty_id: crate::hir::identy::HirId, structs: &HashMap<crate::hir::identy::HirId, StructType<'ctx>>) -> AnyTypeEnum<'ctx> {
		...
		match &ty.vari {
			crate::hir::types::HirTypeVari::Int{bit: 8, ..} => ctx.i8_type().into(),
			crate::hir::types::HirTypeVari::Int{bit: 16, ..} => ctx.i16_type().into(),
			crate::hir::types::HirTypeVari::Int{bit: 32, ..} => ctx.i32_type().into(),
			crate::hir::types::HirTypeVari::Int{bit: 64, ..} => ctx.i64_type().into(),
			crate::hir::types::HirTypeVari::Int{bit: 128, ..} => ctx.i128_type().into(),
			crate::hir::types::HirTypeVari::Float{bit: crate::hir::types::HirFloatSize::F16} => ctx.f16_type().into(),
			crate::hir::types::HirTypeVari::Float{bit: crate::hir::types::HirFloatSize::F32} => ctx.f32_type().into(),
			crate::hir::types::HirTypeVari::Float{bit: crate::hir::types::HirFloatSize::F64} => ctx.f64_type().into(),
			crate::hir::types::HirTypeVari::Float{bit: crate::hir::types::HirFloatSize::F128} => ctx.f128_type().into(),
			crate::hir::types::HirTypeVari::Int{..} => panic!("unimplemented int size"),
