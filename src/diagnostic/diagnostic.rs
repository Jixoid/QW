...
impl Message {
  pub fn new(kind: MsgKind, pos: Word, msg: &str, pars: Vec<String>) -> Self { Message {kind, pos, msg: msg.to_string(), pars, notes: Vec::new()} }

  pub fn fatal(pos: Word, msg: &str, pars: Vec<String>) -> Self { Self::new(MsgKind::Fatal, pos, msg, pars) }
  pub fn error(pos: Word, msg: &str, pars: Vec<String>) -> Self { Self::new(MsgKind::Error, pos, msg, pars) }
  pub fn warn(pos: Word, msg: &str, pars: Vec<String>) -> Self  { Self::new(MsgKind::Warn, pos, msg, pars) }
  pub fn hint(pos: Word, msg: &str, pars: Vec<String>) -> Self  { Self::new(MsgKind::Hint, pos, msg, pars) }
  pub fn note(pos: Word, msg: &str, pars: Vec<String>) -> Self  { Self::new(MsgKind::Note, pos, msg, pars) }
